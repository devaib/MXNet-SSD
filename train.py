...
if __name__ == '__main__':
    ...
    #args.val_path= os.path.join(os.getcwd(), 'data', 'kitti', 'rec', 'train_total_small_total.rec')
    args.val_path = os.path.join(os.getcwd(), 'data', 'caltech-pedestrian-dataset-converter', 'new_rec_all', 'val.rec')
