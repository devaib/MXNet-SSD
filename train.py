...
if __name__ == '__main__':
    ...
    # customized
    args.train_path = os.path.join(os.getcwd(), 'data', 'caltech-pedestrian-dataset-converter', 'rec', 'train-large.rec')
    args.train_list = ""
    args.val_path = os.path.join(os.getcwd(), 'data', 'caltech-pedestrian-dataset-converter', 'rec', 'val-large.rec')
    args.val_list = ""
    ...
    args.prefix = os.path.join(os.getcwd(), 'model', 'resnet101', 'resnet-101-caltech-large')
    args.gpus = '0'
    args.epoch = 0
    args.begin_epoch = 0
    args.end_epoch = 10
