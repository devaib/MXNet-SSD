...
if __name__ == '__main__':
    ...
    #args.train_path = os.path.join(os.getcwd(), 'data', 'kitti', 'rec', 'car', 'train_total_large_total.rec')
    args.train_path = os.path.join(os.getcwd(), 'data', 'caltech-pedestrian-dataset-converter', 'rec_h-gt20-lt50_v-gt0.2', 'train.rec')
    ...
    #args.val_path= os.path.join(os.getcwd(), 'data', 'kitti', 'rec', 'car', 'train_total_large_total.rec')
    args.val_path = os.path.join(os.getcwd(), 'data', 'caltech-pedestrian-dataset-converter', 'rec_h-gt20-lt50_v-gt0.2', 'val.rec')
    #args.val_path = os.path.join(os.getcwd(), 'data', 'caltech-pedestrian-dataset-converter', 'rec_h-gt50_v-gt0.5', 'val.rec')
    #args.val_path = os.path.join(os.getcwd(), 'data', 'caltech-pedestrian-dataset-converter', 'rec_h-gt20-lt50_v-gt0.5', 'val.rec')
    args.val_list = ""
    args.network = 'mobilenet_first_layer'
    ...
    args.prefix = os.path.join(os.getcwd(), 'model', 'mobilenet', 'mobilenet-Caltech-small', 'mobilenet')
    ...
    #args.lr_refactor_step = '30, 60'
    args.lr_refactor_ratio = 0.1
    args.freeze_pattern = ""
    args.log_file = 'log/mobilenet_small.log'
    args.monitor = 0
