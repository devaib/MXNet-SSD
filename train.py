...
if __name__ == '__main__':
    ...
    #args.prefix = os.path.join(os.getcwd(), 'model', 'resnet50', 'resnet-50-Caltech-original', 'resnet-50')
    args.prefix = os.path.join(os.getcwd(), 'model', 'resnet50', 'resnet-50-Caltech-test', 'mean_rgb', 'resnet-50')
    args.gpus = '0,1,2,3'
    args.epoch = 0
    args.begin_epoch = 0
    args.end_epoch = 8
    ...
    args.freeze_pattern = ""
    args.log_file = 'log/train_mean_rgb.log'
    args.monitor = 0
