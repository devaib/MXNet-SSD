...
%     
  ...
  case 'my_update'
    ...
    % usage instructions
    text(size(img,2)/2,size(img,1),sprintf('''SPACE'': Next Image  |  ''-'': Previous Image  |  ''x'': +1000  |  ''y'': -1000 | ''q'': quit'), 'parent', h(1).axes,'color','g','HorizontalAlignment','center','VerticalAlignment','bottom','FontSize',8,'FontWeight','bold', 'BackgroundColor','black');
